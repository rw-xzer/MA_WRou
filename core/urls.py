...
urlpatterns = [
  ...
  path("api/shop/rewards/create/", views.api_create_reward, name="api_create_reward"),
  path("api/shop/rewards/<int:reward_id>/update/", views.api_update_reward, name="api_update_reward"),
  path("api/shop/rewards/<int:reward_id>/delete/", views.api_delete_reward, name="api_delete_reward"),
  path("api/customization/owned/", views.api_owned_customization, name="api_owned_customization"),
